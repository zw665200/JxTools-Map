...
public class WaveView extends View {
    ...
    public static final int[] SWEEP_GRADIENT_COLORS = new int[]{0xFF99867f, 0xFF99867f, 0xFF99867f};
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (strokeWidth > 0) {
            ...
            //绘制内环
            RectF rf1 = new RectF(strokeWidth, strokeWidth / 1.0f, width - 1.2f * strokeWidth, width - strokeWidth);
            canvas.drawArc(rf1, 130, 280, false, outerRingPaint);

            if (progress > 0) {
                RectF rf = new RectF(strokeWidth, strokeWidth / 1.0f, width - strokeWidth, width - strokeWidth);
